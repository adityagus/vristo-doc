...
<\/script>
`,-1),A={class:"panel"},N={class:"flex items-center justify-between mb-5"},Y=e("h5",{class:"font-semibold text-lg dark:text-white-light"},"Autosaving",-1),D=a('<span class="flex items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ltr:mr-2 rtl:ml-2"><path d="M17 7.82959L18.6965 9.35641C20.239 10.7447 21.0103 11.4389 21.0103 12.3296C21.0103 13.2203 20.239 13.9145 18.6965 15.3028L17 16.8296" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path opacity="0.5" d="M13.9868 5L10.0132 19.8297" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path d="M7.00005 7.82959L5.30358 9.35641C3.76102 10.7447 2.98975 11.4389 2.98975 12.3296C2.98975 13.2203 3.76102 13.9145 5.30358 15.3028L7.00005 16.8296" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path></svg> Code </span>',1),O=[D],T={class:"markdown-editor mb-5 rtl:text-right prose dark:prose-invert"},W=e("pre",null,`<!-- basic -->
...
<script lang="ts" setup>
  ...
  \`);
<\/script>
`,-1),F=w({__name:"markdown-editor",setup(Z){k({title:"Markdown Editor"});const{codeArr:i,toggleCode:n}=f(),l=p(`# Basic Example
Go ahead, play around with the editor! Be sure to check out **bold** and *italic* styling, or even[links](https://google.com). You can type the Markdown syntax, use the toolbar, or use shortcuts like 'cmd-b' or 'ctrl-b'.
...
By default, it saves every 10 seconds, but this can be changed. When this textarea is included in a form, it will automatically forget the saved value when the form is submitted.
`);return($,t)=>{const c=y("vue-easymde");return r(),b("div",null,[x,e("div",_,[C,e("div",L,[e("div",B,[e("div",M,[q,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:t[0]||(t[0]=o=>s(n)("code1"))},U)]),e("div",j,[h(c,{modelValue:l.value,"onUpdate:modelValue":t[1]||(t[1]=o=>l.value=o),ref:"editor1",highlight:!0,configs:{spellChecker:!1}},null,8,["modelValue"])]),s(i).includes("code1")?(r(),m(u,{key:0},{default:g(()=>[E]),_:1})):v("",!0)]),e("div",A,[e("div",N,[Y,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:t[2]||(t[2]=o=>s(n)("code2"))},O)]),e("div",T,[h(c,{modelValue:d.value,"onUpdate:modelValue":t[3]||(t[3]=o=>d.value=o),ref:"editor2",highlight:!0,configs:{spellChecker:!1,autosave:{enabled:!0,delay:1e3,uniqueId:"mde-autosave-demo"}}},null,8,["modelValue"])]),s(i).includes("code2")?(r(),m(u,{key:0},{default:g(()=>[W]),_:1})):v("",!0)])])])])}}});export{F as default};
