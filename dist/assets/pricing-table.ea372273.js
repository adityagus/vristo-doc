import{a as h,r as u,e as i,f as m,g as e,u as r,D as n,w as c,y as p,n as b,s as g,A as v,i as w,z as s}from"./vendor.14f711c1.js";import{c as f,_ as x}from"./codePreview.07904b8d.js";import{u as k}from"./main.e1d3eec4.js";const y=e("ul",{class:"flex space-x-2 rtl:space-x-reverse"},[e("li",null,[e("a",{href:"javascript:;",class:"text-primary hover:underline"},"Components")]),e("li",{class:"before:content-['/'] ltr:before:mr-2 rtl:before:ml-2"},[e("span",null,"Pricing Table")])],-1),_={class:"pt-5 space-y-8"},B={class:"panel"},M={class:"flex items-center justify-between mb-5"},j=e("h5",{class:"font-semibold text-lg dark:text-white-light"},"Basic",-1),C=s('<span class="flex items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ltr:mr-2 rtl:ml-2"><path d="M17 7.82959L18.6965 9.35641C20.239 10.7447 21.0103 11.4389 21.0103 12.3296C21.0103 13.2203 20.239 13.9145 18.6965 15.3028L17 16.8296" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path opacity="0.5" d="M13.9868 5L10.0132 19.8297" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path d="M7.00005 7.82959L5.30358 9.35641C3.76102 10.7447 2.98975 11.4389 2.98975 12.3296C2.98975 13.2203 3.76102 13.9145 5.30358 15.3028L7.00005 16.8296" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path></svg> Code </span>',1),L=[C],S=s('<div class="mb-5"><div class="max-w-[320px] md:max-w-[990px] mx-auto"><div class="md:flex justify-between space-y-4 md:space-y-0 md:space-x-4 rtl:space-x-reverse"><div class="p-3 lg:p-5 border border-black dark:border-[#1b2e4b] text-center rounded group hover:border-primary"><h3 class="text-xl lg:text-2xl">Beginner Savers</h3><div class="border-t border-black dark:border-white-dark w-1/5 mx-auto my-6 group-hover:border-primary"></div><p class="text-[15px]">For people who are starting out in the water saving business</p><div class="my-7 p-2.5 text-center text-lg group-hover:text-primary"><strong class="text-[#3b3f5c] dark:text-white-dark text-3xl lg:text-5xl group-hover:text-primary">$19</strong> / monthly </div><ul class="space-y-2.5 mb-5 font-semibold group-hover:text-primary"><li class="flex justify-center items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 ltr:mr-1 rtl:ml-1 rtl:rotate-180 shrink-0"><path d="M4 12H20M20 12L14 6M20 12L14 18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg> Free water saving e-book </li><li class="flex justify-center items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 ltr:mr-1 rtl:ml-1 rtl:rotate-180 shrink-0"><path d="M4 12H20M20 12L14 6M20 12L14 18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg> Free access to forums </li><li class="flex justify-center items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 ltr:mr-1 rtl:ml-1 rtl:rotate-180 shrink-0"><path d="M4 12H20M20 12L14 6M20 12L14 18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg> Beginners tips </li></ul><a href="#" target="_self" class="btn text-black shadow-none group-hover:text-primary group-hover:border-primary group-hover:bg-primary/10 dark:text-white-dark dark:border-white-dark/50">Buy Now</a></div><div class="p-3 lg:p-5 border border-black dark:border-[#1b2e4b] text-center rounded group hover:border-primary"><h3 class="text-xl lg:text-2xl">Advanced Savers</h3><div class="border-t border-black dark:border-white-dark w-1/5 mx-auto my-6 group-hover:border-primary"></div><p class="text-[15px]">For experienced water savers who&#39;d like to push their limits</p><div class="my-7 p-2.5 text-center text-lg group-hover:text-primary"><strong class="text-[#3b3f5c] dark:text-white-dark text-3xl lg:text-5xl group-hover:text-primary">$29</strong> / monthly </div><ul class="space-y-2.5 mb-5 font-semibold group-hover:text-primary"><li class="flex justify-center items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 ltr:mr-1 rtl:ml-1 rtl:rotate-180 shrink-0"><path d="M4 12H20M20 12L14 6M20 12L14 18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg> Free water saving e-book </li><li class="flex justify-center items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 ltr:mr-1 rtl:ml-1 rtl:rotate-180 shrink-0"><path d="M4 12H20M20 12L14 6M20 12L14 18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg> Free access to forums </li><li class="flex justify-center items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 ltr:mr-1 rtl:ml-1 rtl:rotate-180 shrink-0"><path d="M4 12H20M20 12L14 6M20 12L14 18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg> Advanced saving tips </li></ul><a href="#" target="_self" class="btn text-black shadow-none group-hover:text-primary group-hover:border-primary group-hover:bg-primary/10 dark:text-white-dark dark:border-white-dark/50">Buy Now</a></div><div class="p-3 lg:p-5 border border-black dark:border-[#1b2e4b] text-center rounded group hover:border-primary"><h3 class="text-xl lg:text-2xl">Pro Savers</h3><div class="border-t border-black dark:border-white-dark w-1/5 mx-auto my-6 group-hover:border-primary"></div><p class="text-[15px]">For all the professionals who&#39;d like to educate others, too</p><div class="my-7 p-2.5 text-center text-lg group-hover:text-primary"><strong class="text-[#3b3f5c] dark:text-white-dark text-3xl lg:text-5xl group-hover:text-primary">$79</strong> / monthly </div><ul class="space-y-2.5 mb-5 font-semibold group-hover:text-primary"><li class="flex justify-center items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 ltr:mr-1 rtl:ml-1 rtl:rotate-180 shrink-0"><path d="M4 12H20M20 12L14 6M20 12L14 18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg> Access to all books </li><li class="flex justify-center items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 ltr:mr-1 rtl:ml-1 rtl:rotate-180 shrink-0"><path d="M4 12H20M20 12L14 6M20 12L14 18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg> Unlimited board topics </li><li class="flex justify-center items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 ltr:mr-1 rtl:ml-1 rtl:rotate-180 shrink-0"><path d="M4 12H20M20 12L14 6M20 12L14 18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg> Beginners tips </li></ul><a href="#" target="_self" class="btn text-black shadow-none group-hover:text-primary group-hover:border-primary group-hover:bg-primary/10 dark:text-white-dark dark:border-white-dark/50">Buy Now</a></div></div></div></div>',1),F=e("pre",null,`<!-- basic -->
...
`,-1),re=h({__name:"pricing-table",setup(K){k({title:"Pricing Table"});const{codeArr:a,toggleCode:d}=f(),l=u(!1);return(Q,t)=>(i(),m("div",null,[y,e("div",_,[e("div",B,[e("div",M,[j,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:t[0]||(t[0]=o=>r(d)("code1"))},L)]),S,r(a).includes("code1")?(i(),n(x,{key:0},{default:c(()=>[F]),_:1})):p("",!0)]),e("div",H,[e("div",P,[N,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:t[1]||(t[1]=o=>r(d)("code2"))},A)]),e("div",D,[e("div",G,[e("div",T,[e("span",{class:b(l.value?"text-white-dark":"text-primary")},"Monthly",2),e("label",U,[g(e("input",{id:"custom_switch_checkbox1",type:"checkbox",class:"custom_switch absolute ltr:left-0 rtl:right-0 top-0 w-full h-full opacity-0 z-10 cursor-pointer peer","onUpdate:modelValue":t[2]||(t[2]=o=>l.value=o)},null,512),[[v,l.value]]),V]),e("span",{class:b(["relative",l.value?"text-primary":"text-white-dark"])},[w("Yearly "),E],2)]),I])]),r(a).includes("code2")?(i(),n(x,{key:0},{default:c(()=>[R]),_:1})):p("",!0)]),e("div",W,[e("div",X,[z,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:t[3]||(t[3]=o=>r(d)("code3"))},Y)]),q,r(a).includes("code3")?(i(),n(x,{key:0},{default:c(()=>[J]),_:1})):p("",!0)])])]))}});export{re as default};
